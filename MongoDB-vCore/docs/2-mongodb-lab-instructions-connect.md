...
3. The first task is to locate and connect to the source MongoDB. Open the Microsoft Edge browser and navigate to +++https://portal.azure.com+++. Sign in with the following credentials: 
